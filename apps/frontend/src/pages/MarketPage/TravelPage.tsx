...
const TravelPage: React.FC = () => {
    ...
    const travelCards: TravelCardData[] = [
        {
            ...
            title: 'Tokyo',
            price: '$499',
            description: 'Tokyo is a dynamic city where tradition meets modernity. From its ancient temples like Senso-ji to the futuristic skyline dominated by the Tokyo Skytree, it offers a rich cultural experience.',
            options: ['Cultural Getaway', 'Modern City Escape', 'Family Adventure'],
            category: '🌆 City Break',
        },
        {
            id: 'bali-id',
            ...
            title: 'Bali',
            price: '$599',
            description: 'Relax on stunning beaches and explore the spiritual heart of Indonesia.',
        ...
        },
        {
            ...
            title: 'Italy',
            price: '$650',
            description: 'Discover ancient history, art, and delicious cuisine across Italy.',
        ...
        },
        {
            ...
            title: 'Swiss Alps',
            price: '$720',
            description: 'Majestic mountains, pristine lakes, and world-class hiking trails await.',
        ...
        },
        {
            ...
            title: 'Amazon',
            price: '$850',
            description: 'Explore the unparalleled biodiversity of the Amazon rainforest.',
    ...
    const [selectedCard, setSelectedCard] = useState<TravelCardData | null>(null);
    ...
    const handleCardClick = (cardData: TravelCardData) => setSelectedCard(cardData);
    const handleCloseModal = () => setSelectedCard(null);
    const handleCategoryChange = (category: string | null) => setActiveCategory(category);
    ...
    return (
        <div className={`w-full mx-auto min-h-screen bg-gradient-to-b from-[#A4D5DA] via-[#D9D8B5] to-[#276A7D] overflow-x-hidden relative transition-opacity duration-500 ${isPageLoaded ? 'opacity-100' : 'opacity-0'}`}>
            <div className="pb-28">
                ...
                >
                    <h2 className="font-unbounded text-lg sm:text-xl md:text-2xl font-medium m-0 text-gray-800"><AnimatedText text='In' delay={100}/> <i><AnimatedText text='Focus' delay={200}/></i></h2>
                    <a href="#" onClick={(e) => e.preventDefault()} className="text-blue-600 hover:text-blue-800 text-sm sm:text-base md:text-lg no-underline font-medium">View All</a>
                </motion.div>
                    ...
                    <AnimatePresence mode="popLayout">
                        {filteredTravelCards.length > 0 ? (
                            filteredTravelCards.map((card, index) => (
                                ...
                                >
                                    <DestinationCard card={card} onCardClick={handleCardClick} />
                                </motion.div>
                            ))
                        ) : (
                            <motion.div
                ...
                <motion.div
                    ...
                    className="p-4 sm:p-5 md:p-6 text-white mx-4 mb-6"
                >
                    <div className="flex items-center gap-2">
                        <h3 className="font-sf-pro text-[1.7rem] sm:text-[2.8rem] md:text-[3rem] font-semibold m-0 mb-2 leading-[1.2]"><i className="mr-2"><AnimatedText text='Ask AI ' delay={500}/></i> <AnimatedText text='For Travel Recommendations!' delay={600}/></h3>
            ...
            <TravelDetailModal cardData={selectedCard} onClose={handleCloseModal} />
        </div>
    );
};
